...
//   @override
//   State<DoctorDetailPage> createState() => _MyWidgetState();
// }

// class _MyWidgetState extends State<DoctorDetailPage> {
...
//     return Scaffold(
//       appBar: AppBar(title: Text('Chi tiết bác sĩ')),
...
//               CircleAvatar(
//                 radius: 50.0,
//                 backgroundImage: NetworkImage(widget.doctor.profileImageBase64),
//               ),
...
//               ElevatedButton(
//                 onPressed: _openMap,
//                 child: Text('Xem vị trí trên bản đồ'),
//               ),
//               SizedBox(height: 20),
//               Row(
            ...
            children: [
                    ...
                    child:
                        widget.doctor.profileImageBase64.isNotEmpty
                            ? ClipRRect(
                              borderRadius: BorderRadius.circular(12),
                              child: Image.network(
                                widget.doctor.profileImageBase64,
                                fit: BoxFit.fitWidth,
                              ),
                            )
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color(0xffF0EFFF),
                  border: Border.all(color: Color(0xffC8C4FF), width: 1),
                ),
                child: Column(
                  children: [
                    Row(
      ...
      _requestDatabase
          ...
          .catchError((error) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  'Failed to book your appointment, Try Again later!!',
                ),
              ),
            );
          });
