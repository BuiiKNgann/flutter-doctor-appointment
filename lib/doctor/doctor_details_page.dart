...
//     super.initState();
//     _generateTimeSlots();
//     _fetchReviews(); // Lấy đánh giá và cập nhật theo thời gian thực
...
//     DateTime startTime = DateTime(2025, 1, 1, 8, 0); // Giờ bắt đầu: 8:00 AM
//     DateTime endTime = DateTime(2025, 1, 1, 17, 0); // Giờ kết thúc: 5:00 PM

//     // Nếu ngày được chọn là hôm nay, bắt đầu từ giờ hiện tại hoặc gần nhất
//     if (_selectedDate != null &&
//         _selectedDate!.year == now.year &&
//         _selectedDate!.month == now.month &&
//         _selectedDate!.day == now.day) {
//       startTime = DateTime(2025, 1, 1, now.hour, now.minute);
//       // Làm tròn lên đến 30 phút tiếp theo nếu cần
...
//           },
//           onError: (error) {
//             _showSnackBar('Error fetching reviews: $error', isError: true);
//           },
//         );
//   }
...
//       setState(() {});
//     } catch (e) {
//       _showSnackBar('Error checking booked slots: $e', isError: true);
//     }
//   }
...
//             ),
//             child: IconButton(
//               icon: Icon(Icons.favorite_border_rounded, color: Colors.red[400]),
//               onPressed: () {},
//             ),
//           ),
//         ],
...
//               ).then(
//                 (_) => _fetchReviews(),
//               ); // Cập nhật đánh giá sau khi quay lại
//             },
//             child: _buildInfoCard(
...
//                   ),
//                   onPressed:
//                       _selectedDate == null ? null : () => setState(() {}),
...
//                 // Kiểm tra nếu khung giờ đã qua (chỉ áp dụng cho ngày hiện tại)
//                 bool isPast = false;
//                 if (isToday) {
...
//       context: context,
//       initialDate: now,
//       firstDate: now, // Giới hạn ngày sớm nhất là hiện tại
//       lastDate: DateTime(2101),
//       builder: (context, child) {
//         return Theme(
//           data: Theme.of(context).copyWith(
...
//       setState(() {
//         _selectedDate = picked;
//         _selectedTime = null; // Đặt lại giờ khi ngày thay đổi
//         _generateTimeSlots(); // Cập nhật danh sách khung giờ
//       });
//       await _checkBookedTimeSlots();
//     }
//   }
...
//           });
//     } else {
//       _showSnackBar('Vui lòng chọn ngày và giờ khám', isError: true);
//     }
//   }
// }
