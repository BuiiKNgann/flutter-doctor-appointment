...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final DatabaseReference _chatListDatabase = FirebaseDatabase.instance
      .ref()
      .child('ChatList');
  final DatabaseReference _chatDatabase = FirebaseDatabase.instance.ref().child(
    'Chat',
  );
                      ...
                      return Align(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isMe ? Color(0xffC8C4FF) : Color(0xffE3E3E3),
                            borderRadius:
                                isMe
                                    ? BorderRadius.only(
              ...
              child: Row(
                children: [
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          border: OutlineInputBorder(
                            ...
                            borderSide: BorderSide(color: Color(0xffC8C4FF)),
                          ),
                        ),
                      ),
                    ),
                  ...
                  IconButton(
                    ...
                    icon: Icon(Icons.send, size: 30, color: Color(0xff0064FA)),
                  ),
                ],
              ),
            ),
